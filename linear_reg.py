...
plt.plot(ages_test,reg.predict(ages_test),color='b')
plt.scatter(ages_train,net_worths_train,color='r',label='training')
plt.scatter(ages_test,net_worths_test,color='b',label='testing')
